...
function setup() {
	...
	inviSprite = createSprite(350,650,200,20);
	inviSprite.visible = false;
	...
	packageBody = Bodies.circle(width/2 , 200 , 5 , {restitution:0.5,density:1.0,friction:0.2, isStatic:true});
...
function draw() {
  ...
  box2.display();
  box3.display();
  collide(packageSprite, groundSprite);
  collide(packageSprite, inviSprite);
